...
namespace EmployeeManager.Models
{
    ...
    {
        public static List<SelectListItem> GetCountryNames()
        {
            var countries = new List<SelectListItem>();
            foreach(var country in Enum.GetValues(typeof(CountryList)))
            {
                string name = country.GetType().GetMember(country.ToString()).First().GetCustomAttribute<DescriptionAttribute>().Description;
